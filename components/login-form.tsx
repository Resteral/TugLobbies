  ...
  return (
    <Card className="w-full max-w-md bg-slate-900 border-slate-800">
      <CardHeader className="text-center space-y-4">
        ...
        <CardDescription className="text-slate-400">Sign in to your Zealot Hockey account</CardDescription>
      </CardHeader>
      ...
      <CardContent>
        <form action={formAction} className="space-y-6">
          ...
          <div className="text-center text-slate-400">
            ...
            <Link href="/auth/sign-up" className="text-orange-500 hover:text-orange-400 hover:underline">
              Sign up
            </Link>
          </div>
        </form>
