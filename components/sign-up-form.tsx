  ...
  return (
    <div className="w-full max-w-md space-y-8">
      <div className="space-y-2 text-center">
        <h1 className="text-4xl font-bold tracking-tight text-white">Join the League</h1>
        <p className="text-lg text-gray-400">Create your player profile</p>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className="bg-gray-800 border-gray-700 text-white placeholder:text-gray-500"
            />
            <p className="text-xs text-gray-500">Your unique game account identifier</p>
          </div>
        </div>
